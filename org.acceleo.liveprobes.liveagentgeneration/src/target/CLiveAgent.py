...
class CLiveAgent(BaseLiveAgent):
	...
	def load_code(self, path: str):
		#TODO: Depending on the runner file or the language itself, there will be unique ways
		#to load the code, modify if needed.
	...
	def execute(self, source_file : str, method : str, args : list[str], max_steps : int=300) -> tuple[str, StackRecording]:
        #TODO: Arrange order of events accordingly.
        ...
        while True:
			...
			#TODO: 1. get the lengtht of the stackframes to set height in the recorded stackframes
        ...
        return return_value, stackrecrding
