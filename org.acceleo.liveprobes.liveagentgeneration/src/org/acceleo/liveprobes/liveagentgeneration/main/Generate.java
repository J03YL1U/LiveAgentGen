 ...
 *******************************************************************************/
package org.acceleo.liveprobes.liveagentgeneration.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/acceleo/liveprobes/liveagentgeneration/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
         ...
         */
        if (!isInWorkspace(CfgPackage.class)) {
        	// The normal package registration if your metamodel is in a plugin.
        	resourceSet.getPackageRegistry().put(CfgPackage.eNS_URI, CfgPackage.eINSTANCE);
        }
    }
    ...
    public void registerResourceFactories(ResourceSet resourceSet) {
        ...
        put("cfg", new XMIResourceFactoryImpl());
